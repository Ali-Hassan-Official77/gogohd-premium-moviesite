...
export default function RootLayout({children}){return <html lang="en" className={manrope.variable}><body><Navbar/><main className="min-h-screen">{children}</main><Footer/></body></html>}
